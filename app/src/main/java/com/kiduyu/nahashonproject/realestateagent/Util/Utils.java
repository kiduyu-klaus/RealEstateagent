package com.kiduyu.nahashonproject.realestateagent.Util;
...
import com.kiduyu.nahashonproject.realestateagent.Constants;
import com.kiduyu.nahashonproject.realestateagent.R;
import com.kiduyu.nahashonproject.realestateagent.TextInputAutoCompleteTextView;
...
import com.kiduyu.nahashonproject.realestateagent.network.models.placebynearby.Result;
...
import com.kiduyu.nahashonproject.realestateagent.rx.ObservableObject;
...
public class Utils {
    ...
    public static Snackbar createSnackbar(Context context, View mainLayout, String message) {
        ...
        Button snackbarButton = (Button) snackbarView.findViewById(R.id.snackbar_action);
